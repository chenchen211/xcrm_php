...
<title>X-Mis系统登录 Power by 连云港信友科技有限公司 服务热线：400-000-9981</title>
...
body {
    background: url(/Public/images/loginbg/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(/Public/images/loginbg/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
<div class="main_box">
	...
	<div class="login_box">
        ...
        <div class="login_form">
    		...
    		<form action="<?php echo U('Login');?>" name="frmlogin" id="login_form" method="post">
    			...
    			<div class="form-group">
    				...
    				<img id="captcha_img" alt="点击更换" title="点击更换" src="<?php echo U('public/verify');?>" class="m">
    			</div>-->
    			<div class="form-group">
                    <label class="t"></label>
	...
	<div class="bottom">Power by  <a href="http://www.xinyou88.com/"target="_blank">连云港信友科技有限公司</a> 服务热线：400-000-9981 <div style="display:none"><script src="http://s96.cnzz.com/stat.php?id=1618465&web_id=1618465" language="JavaScript"></script></div></div>
</div>
</body>
</html>