...
<div class="bjui-pageContent">
    <form action="/index.php/Home/User/edit/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
        ...
        <div class="pageFormContent" data-layout-h="0">
          <table class="table table-condensed table-hover" width="100%">
           <tbody>
			...
			<tr><td>
                <label for="j_title" class="control-label x85">U盾号：</label>
                <input type="text"  size="35" name="memo"  value="<?php echo ($Rs['memo']); ?>" >
            </td></tr>
            </tbody>
            </table>
        </div>
