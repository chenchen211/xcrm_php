...
<tr><td><label for='title_input' class='control-label x85'>型号规格:</label><?php echo ($Rs["title"]); ?></td><td><label for='kucun_input' class='control-label x85'>库存数量:</label><?php echo ($Rs["kucun"]); ?></td></tr>
