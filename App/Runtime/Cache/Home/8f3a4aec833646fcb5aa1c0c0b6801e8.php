<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent">
    <form action="/xcrm/index.php/Home/Proout/edit/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
...
<tr><td><label for='jpguige_input' class='control-label x85'>规格型号:</label><input type='text' id='jpguige' name='jpguige'  size='20' data-toggle='lookup' data-url='/xcrm/index.php/Home/public/proname/navTabId/<?php echo CONTROLLER_NAME;?>'  value='<?php echo ($Rs["jpguige"]); ?>' disabled  ></td><td><label for='shuliang_input' class='control-label x85'>出库数量:</label><input type='text' id='shuliang' name='shuliang' data-rule='required;' size='20'   value='<?php echo ($Rs["shuliang"]); ?>'  disabled ></td></tr>
