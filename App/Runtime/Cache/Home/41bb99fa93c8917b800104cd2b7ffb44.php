...
<form id="pagerForm" data-toggle="ajaxsearch" action="/xcrm/index.php/home/log" method="post">
        ...
        <div class="bjui-searchBar">
            <label>关键词：</label><input type="text" value="<?php echo ($_REQUEST['keys']); ?>" name="keys" class="form-control" size="20" />
             <button type="submit"  class="btn-default" data-icon="search">查询</button>
			  ...
			  <span <?php echo display(CONTROLLER_NAME.'/del'); ?> style="float:right;" ><a href="/xcrm/index.php/home/log/del/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要清理吗？" data-icon="remove">清理</a></span>
        </div>
</form>
