<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent">
    <form action="/xcrm/index.php/Home/Pro/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
		<input type="hidden" name="id" value="<?php echo ($id); ?>">
        <div class="pageFormContent" data-layout-h="0">
          <table class="table table-condensed table-hover" width="100%">
           <tbody>
			<tr><td><label for='name_input' class='control-label x85'>产品名称:</label><input type='text' id='name' name='name' data-rule='required;' size='20'   value='<?php echo ($Rs["name"]); ?>'  ></td><td><label for='fenlei_input' class='control-label x85'>产品分类:</label><input type='text' id='fenlei' name='fenlei'  size='20' data-toggle='lookup' data-url='/xcrm/index.php/Home/public/procate/navTabId/<?php echo CONTROLLER_NAME;?>'  value='<?php echo ($Rs["fenlei"]); ?>'  ></td></tr>
